(define (problem roverprob--s7349077--m25--r2--w11--o11--c3--g16--p7--P4--C07) (:domain Rover)
(:objects
	general - Lander
    ...
    level30 level29 level28 level27 level26 level25 level24 level23 level22 level21 level20 level19 level18 level17 level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - energylevel
	)
(:init
